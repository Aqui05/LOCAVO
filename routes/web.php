...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/all_locations', [LocateController::class, 'allLocation'])->name('locations.list-all');

    Route::get('/all_users', [LocateController::class, 'allUser'])->name('locations.list-user');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/locations/{id}/confirm-delete', [LocateController::class, 'confirmDeleteLocation'])->
