    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="card bg-success text-white">
                ...
                <a href="{{ route('locations.list-all') }}" class="btn btn-light mt-3">Voir toutes les locations</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-black text-white">
                ...
                <a href="{{ route('locations.list-user') }}" class="btn btn-light mt-3">Voir tous les utilisateurs</a>
            </div>
        </div>
    </div>
