                ...
                <tbody>
                    @foreach($locations as $location)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('locations.edit', $location->id) }}" class="btn btn-info btn-sm">Mettre à jour</a>
                                <a href="{{ route('locations.edit', $location->id) }}" class="btn btn-success btn-sm">Mettre à jour</a>
                                <a href="{{ route('locations.cancel', $location->id) }}" class="btn btn-danger btn-sm">Annuler</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
