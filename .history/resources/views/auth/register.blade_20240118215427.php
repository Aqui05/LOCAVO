...
<section class="vh-75 bg-image" style="background-image: <img src="{{ asset('images/LOCAVO.png') }}" alt="Logo"">
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body h-50">
              ...
              <form action="{{ route('auth.register') }}" method="POST" class="vstack gap-3">
                ...
                <p class="text-center text-muted mt-4 mb-0">Have already an account? <a href="{{ route("auth.login") }}" class="fw-bold text-body"><u>Login here</u></a></p>
              </form>
            </div>
          </div>
        </div>
