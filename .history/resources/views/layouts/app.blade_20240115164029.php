...
<body style="background-color: #f8f9fa;">
    ...
    <header>
        <div class="container">
            <h1 class="text-center py-3">Bienvenue sur Ma Voiture App</h1>
        </div>
    </header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
        <div class="container">
            ...
            <form action="{{ route('cars.search') }}" method="GET" class="form-inline">
                ...
                <div class="input-group">
                    ...
                    <button class="btn btn-outline-secondary" type="submit"><i class="bi bi-funnel"></i> Filtrer</button>
                </div>
            </form>
