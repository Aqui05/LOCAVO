   ...
   <br>
    ...
    <div class="text-center">
        ...
        <ul class="list-inline">
            <!-- Liens statiques pour chaque marque -->
            <li class="list-inline-item">
                <a href="{{ route('cars.index', ['criteria' => 'marque', 'value' => 'Marque1']) }}">Marque1</a>
            </li>
            <li class="list-inline-item">
                <a href="{{ route('cars.index', ['criteria' => 'marque', 'value' => 'Marque2']) }}">Marque2</a>
            </li>
            <!-- Ajoutez d'autres liens pour chaque marque -->
        </ul>
    </div>
