<section class="vh-100 bg-image"
  ...
  <div class="mask d-flex align-items-center h-100 gradient-custom-3">
    ...
    function registerUser() {
        ...
        var formData = {
            name: document.getElementById('form3Example1cg').value,
            email: document.getElementById('form3Example3cg').value,
            password: document.getElementById('form3Example4cg').value,
            password_confirmation: document.getElementById('form3Example4cdg').value
        };

        // Effectuez une requête AJAX vers la route API Laravel
