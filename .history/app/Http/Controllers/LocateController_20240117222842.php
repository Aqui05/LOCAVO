...
{
    // Vérifiez si la location peut être annulée (ajoutez vos propres conditions)
    if ($location->status === 'confirmé' || $location->status === 'en cours') {
        // Mettez à jour le statut à "annulé"
