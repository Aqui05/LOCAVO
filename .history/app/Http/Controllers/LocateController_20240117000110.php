...
{
    if ($location->isUpdateAllowed()) {
        $location->update($request->all());
        return redirect()->route('locations.show', $location)->with('success', 'Détails mis à jour avec succès');
    } else {
        return redirect()->route('locations.show', $location)->with('error', 'Mise à jour non autorisée');
    }
}
