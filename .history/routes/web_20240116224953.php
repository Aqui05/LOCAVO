...
Route::middleware(['auth'])->group(function () {
    Route::get('/locations/create/{car}', 'LocateController@createLocation')->name('locations.create');
    Route::post('/locations/store/{car}', 'LocateController@storeLocation')->name('locations.store');
});


Route::get('/confirmation/{location}', 'LocateController@confirmation')->name('confirmation');
