...
Route::middleware(['auth'])->group(function () {
    Route::get('/locations/create/{car}', 'LocationController@create')->name('locations.create');
    Route::post('/locations/store/{car}', 'LocationController@store')->name('locations.store');
});
