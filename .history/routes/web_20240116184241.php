...
Route::middleware(['auth'])->group(function () {
    Route::get('/locations/create/{car}', 'LocationController@createLocation')->name('locations.create');
    Route::post('/locations/store/{car}', 'LocationController@storeLocation')->name('locations.store');
});


Route::get('/confirmation/{location}', 'LocationController@confirmation')->name('confirmation');
